...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "restaurant" ADD CONSTRAINT "restaurant_street_address_address_street_address_1_fk" FOREIGN KEY ("street_address") REFERENCES "public"."address"("street_address_1") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "restaurant" ADD CONSTRAINT "restaurant_zip_code_address_zip_code_fk" FOREIGN KEY ("zip_code") REFERENCES "public"."address"("zip_code") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
